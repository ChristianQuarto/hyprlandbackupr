...
CONF.read(expanduser("~/.config/hypr/scripts/wificonfig.ini"))
...
def dmenu_cmd(num_lines, prompt="Networks", active_lines=None):
    ...
    command = shlex.split(CONF.get('dmenu', 'dmenu_command', fallback="rofi -i -theme ~/.config/rofi/wifi/wifi.rasi"))
