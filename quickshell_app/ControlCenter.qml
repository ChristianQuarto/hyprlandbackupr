...
PanelWindow {
    ...
    property bool mprisPlaying:  mprisPlayer ? mprisPlayer.playbackState === MprisPlaybackState.Playing : false
    ...
    Process { id: mprisCtlProc;   running: false }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Image {
                            ...
                            source: cc.mprisPlayer && cc.mprisPlayer.trackArtUrl ? cc.mprisPlayer.trackArtUrl : ""
                            visible: source !== ""
                            asynchronous: true
                        }
                        Text {
                            anchors.centerIn: parent
                            visible: !cc.mprisPlayer || !cc.mprisPlayer.trackArtUrl
                            text: "󰎈"
                            color: Colors.color6
                            font.pixelSize: 26
                            font.family: "JetBrainsMono Nerd Font"
                    ...
                    Column {
                        ...
                        Text {
                            width: parent.width
                            text: cc.mprisPlayer ? (cc.mprisPlayer.trackTitle || "No title") : ""
                            color: Colors.fg
                            font.pixelSize: 13; font.bold: true
                            font.family: "JetBrainsMono Nerd Font"
                        ...
                        Text {
                            width: parent.width
                            text: cc.mprisPlayer ? (cc.mprisPlayer.trackArtist || "") : ""
                            color: Colors.color8
                            font.pixelSize: 11
                            font.family: "JetBrainsMono Nerd Font"
                            elide: Text.ElideRight
                        ...
                        Row {
                            ...
                            Text {
                                ...
                                font.pixelSize: 16
                                font.family: "JetBrainsMono Nerd Font"
                                MouseArea { anchors.fill: parent; onClicked: if (cc.mprisPlayer) cc.mprisPlayer.previous() }
                            }
                            Text {
                                text: cc.mprisPlaying ? "" : ""
                                color: Colors.color6
                                font.pixelSize: 18
                                font.family: "JetBrainsMono Nerd Font"
                                MouseArea { anchors.fill: parent; onClicked: if (cc.mprisPlayer) cc.mprisPlayer.playPause() }
                            }
                            Text {
                                text: ""
                                color: Colors.color6
                                font.pixelSize: 16
                                font.family: "JetBrainsMono Nerd Font"
                                MouseArea { anchors.fill: parent; onClicked: if (cc.mprisPlayer) cc.mprisPlayer.next() }
                            }
                        }
                    }
                }
